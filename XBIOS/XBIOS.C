...
/*-----------------------------------------------------------------------------------*
* FUNCTION : Xbios_DspSetVectors( fXbios afRecv,fXbios afTrans )
* ACTION   : Xbios_DspSetVectors
* CREATION : 28.03.2005 PNK
*-----------------------------------------------------------------------------------*/

void	Xbios_DspSetVectors( fXbios afRecv,fXbios afTrans )
{
	Xbios_Call_PP( eXBIOS_DSPSETVECTORS, (void*)(U32)afRecv, (void*)(U32)afTrans );
}
...
{
	return( (S16)Xbios_Call_PLWWWWW( eXBIOS_FLOPRD, apBuffer, (S32)aReserved, (S16)aDev, (S16)aSector, (S16)aTrack, (S16)aSide, (S16)aCount ) );
}
...
{
	return( (S16)Xbios_Call_PLWWWWW( eXBIOS_FLOPVER, apBuffer, (S32)aReserved, (S16)aDev, (S16)aSector, (S16)aTrack, (S16)aSide, (S16)aCount ) );
}
...
{
	return( (S16)Xbios_Call_PLWWWWW( eXBIOS_FLOPWR, apBuffer, (S32)aReserved, (S16)aDev, (S16)aSector, (S16)aTrack, (S16)aSide, (S16)aCount ) );
}
...
/*-----------------------------------------------------------------------------------*
* FUNCTION : Xbios_Initmous( const U16 aMode,const void * apParam,fXbios afHandler )
...
{
	Xbios_Call_WPP( eXBIOS_INITMOUS, aMode, apParam, (void*)(U32)afHandler );
}
...
/*-----------------------------------------------------------------------------------*
* FUNCTION : Xbios_Mfpint( const U16 aIntNo,fXbios afVector )
* ACTION   : Xbios_Mfpint
* CREATION : 28.03.2005 PNK
*-----------------------------------------------------------------------------------*/
...
{
	Xbios_Call_WP( eXBIOS_MFPINT, aIntNo, (void*)(U32)afVector );
}
...
/*-----------------------------------------------------------------------------------*
* FUNCTION : Xbios_Supexec( fXbios afFunc )
...
{
	return( Xbios_Call_P( eXBIOS_SUPEXEC, (void*)(U32)afFunc ) );
}
...
/*-----------------------------------------------------------------------------------*
* FUNCTION : Xbios_Xbtimer( const U16 aTimer,const U16 aControl,const U16 aData,fXbios afHandler )
...
{
	Xbios_Call_WWWP( eXBIOS_XBTIMER, aTimer, aControl, aData, (void*)(U32)afHandler );
}
